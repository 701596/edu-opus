-- Fix create_school_invite to populate invited_by
DROP FUNCTION IF EXISTS create_school_invite(uuid, text, user_role, integer);
...
BEGIN
  ...
  INSERT INTO school_invites (school_id, email, role, token, security_code, expires_at, invited_by)
  VALUES (
    p_school_id, 
    p_email, 
    p_role, 
